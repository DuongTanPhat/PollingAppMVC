			...
			<div class="ui grid stackable padded">
				<div class="column">
					<table class="ui celled striped table">
						<thead>
							<tr>
								<th colspan="3">Danh sách Tag</th>
							</tr>
						</thead>
						<tbody>
							<c:forEach var="u" items="${listTagA}">
								<tr>
									<td>
									...
									<td class="right aligned collapsing"><a
										href="tag/edit/${u.id}.htm"><button
												class="ui green button">Sửa</button></a> <a
										href="tag/delete/${u.id}.htm"><button
												class="ui red button">Xóa</button></a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
