...
<body>
		...
		<div class="item">
			...
			<div class="menu">
				<a class="active item" href="adminInsertTag.htm">
					<div>
						<i class="cogs icon"></i>Thêm
					</div>
		...
		<div class="main-content">
			<div class="ui grid stackable padded">
				<div class="column">
					...
					<form id="formid" class="ui form" action="adminInsertTag.htm?${_csrf.parameterName}=${_csrf.token}"
						method="post">
						<div class="field" id="fieldid">
							<label>ID</label>
							<form:input path="tag.id" type="text" minlength="1" maxlength="4" name="id" placeholder="Mã" />
						</div>
						<div class="field">
							<label>Name</label>
							<form:input path="tag.name" type="text" name="name"
								placeholder="Tên Tag" />
						</div>
	...
	<script type="text/javascript">
		var info_id = document.getElementById("id.errors");
		if (info_id.innerHTML != "") {
			var input_form = document.getElementById("formid");
			input_form.setAttribute("class", "ui large form error");
			var input_email = document.getElementById("fieldid");
