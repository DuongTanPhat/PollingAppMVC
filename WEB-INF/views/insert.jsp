...
<script
	src="${pageContext.servletContext.contextPath}/assets/library/jquery.min.js"></script>
<script
...
<body>
	...
	<div class="ui segment">
		<p>
		<form action="topic/insert.htm?${_csrf.parameterName}=${_csrf.token}" class="ui form" method="post"
			enctype="multipart/form-data" id="formid">
			<h4 class="ui dividing header">Tạo bầu chọn</h4>
			<div class="field">
				<label>Name</label>
