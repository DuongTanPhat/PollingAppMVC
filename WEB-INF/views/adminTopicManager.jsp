...
<body>
		...
		<div class="item">
			...
			<div class="menu">
				...
				</a> <a class="active item" href="topicmanager.htm">
					<div>
						<i class="users icon"></i>Quản lí
					</div>
				</a>
			...
			<div class="ui grid stackable padded">
				<div class="column">
					<table class="ui celled striped table">
						<thead>
							<tr>
								<th colspan="3">Danh sách bài đăng</th>
							</tr>
						</thead>
						<tbody>
							<c:forEach var="u" items="${listTopicA}">
								<tr>
									<td><img class="ui avatar image"
										src=${u.photo == null||u.photo == ''?'"images/noimage.jpg"':u.photo}>
										<a class="content" href="vote/${u.id}.htm"
										style="color: black;"> ${u.name} </a></td>
									<td>${u.user.email}</td>
									<td class="right aligned collapsing"> <a
										href="topic/edit/${u.id}.htm"><button
												class="ui green button">Sửa</button></a><%-- <a
										href="topic/delete/${u.id}.htm"> --%><button
												class="ui red button" data-modal-target="${u.id}">Xóa</button><!-- </a> --></td>
								</tr>
